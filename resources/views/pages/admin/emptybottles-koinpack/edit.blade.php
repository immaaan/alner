  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a>Empty Bottles</a></div>
        <div class="breadcrumb-item active">Edit Empty Bottles</div>
      </div>
    </div>
    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        @endif
            ...
            <div class="card-body">
                <form action="{{ route('emptybottle.update', $item->id) }}" method="POST" enctype="multipart/form-data">{{-- untuk menyimpan sebuah data menggunakan functioan 'store' --}}
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="final_price" placeholder="Final Price" value="{{ $item->final_price }}" required>
                  </div> --}}
                  <div class="form-group">
                    <label for="price">Discount Price (Rp)</label>
                    <input type="text" class="form-control" name="price" placeholder="Discount" value="{{ $item->price }}" required>
                  </div>
                  <div class="form-group">
                    <div class="row">
