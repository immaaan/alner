  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active">Input Empty Bottles</div>
      </div>
    </div>
    ...
    @else
        @php
            ...
            $__defaults = [
                ...
                // 'final_price'         => $faker->randomNumber(4),
                // 'info'             => $faker->text(200),
    ...
    @endproduction
            ...
            <div class="card-body">
                <form action="{{ route('emptybottle.store') }}" method="POST" enctype="multipart/form-data">{{-- untuk menyimpan sebuah data menggunakan functioan 'store' --}}
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="price" placeholder="Discount Price" value="{{ $__defaults['price'] }}" required>
                  </div>
                  <div class="form-group">
                    <div class="row">
