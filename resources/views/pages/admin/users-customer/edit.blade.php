  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Edit Costumers</div>
      </div>
    </div>
    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        @endif
            ...
            <div class="card-body">
                <form action="{{ route('users-customer.update', $item->id) }}" method="POST" enctype="multipart/form-data">{{-- untuk menyimpan sebuah data menggunakan functioan 'store' --}}
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="phone" placeholder="Phone" required value="{{ $item->phone }}">
                  </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="status" class="form-control" required>
                          <option value="{{$item->customer->status != 1 ? 0 : 1}}">Jangan Diubah ( {{$item->customer->status == 1 ? 'Aktif' : 'Tidak Aktif'}} )</option>                          
                          <option value="1">Aktif</option>
                          <option value="0">Tidak Aktif</option>                                                      
                      </select>
                  </div>
