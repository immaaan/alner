  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a>Shopping Carts</a></div>
                  ...
                  <tbody>
                      ...
                      @forelse ($items as $item)                      
                          <tr>
                              ...
                              <td class=""><span class="badge badge-info">{{ $item->qty }}</span> </td>
                              <td class="">
                                @if ($item->product)
                                <span class="badge badge-danger">{{ rupiah($item->qty*$item->product->price) }}</span>
                                @else
                              ...
                              <td width="13%" >
                                {{-- <a href="{{ route('shopping.show', $item->id)}}" 
                                    class="btn btn-success my-1">
                                    <i class="fa fa-eye"></i>
                                </a> --}}

                                <a href="{{ route('shopping.edit', $item->id)}}" 
                                    class="btn btn-info">
                                ...
                                <form action="{{ route('shopping.destroy', $item->id) }}"
                                ...
                                {{-- <form action="{{ route('shopping.restore')}}"
