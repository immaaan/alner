  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active">Edit Shopping Carts</div>
      </div>
    </div>
    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        @endif
            ...
            <div class="card-body">
                <form action="{{ route('shopping.update', $item->id) }}" method="POST">{{-- untuk menyimpan sebuah data menggunakan functioan 'store' --}}
